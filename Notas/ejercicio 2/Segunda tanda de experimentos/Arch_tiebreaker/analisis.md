...
En el cross-experiment [`cross_v1` stage 2](Notas/ejercicio%202/Segunda%20tanda%20de%20experimentos/Cross_LR_Opt_Arch/analisis.md), las 4 arquitecturas (`shallow`, `base`, `wider`, `deeper`) se probaron contra 5 LRs × 3 optimizers × 3 seeds × k=5 folds. Las dos cells del top fueron:
...
![tiebreaker val_acc](Notas/ejercicio%202/Segunda%20tanda%20de%20experimentos/Arch_tiebreaker/tiebreaker_val_acc.png)

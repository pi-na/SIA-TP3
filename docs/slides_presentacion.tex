...
\begin{frame}{Cinco decisiones que afectan a todos los ejercicios}
\centering\normalsize
Antes de mostrar resultados, conviene fijar los cinco elementos que aparecen en cada experimento:\\[1em]
...
\textcolor{muted}{\footnotesize El config tiene un modo \emph{auto} que elige el inicializador según la activación de cada capa.}
\end{frame}
...
\begin{itemize}\setlength\itemsep{0.25em}\small
  ...
  \item \textbf{Adam} ($\beta_1 = 0.9$, $\beta_2 = 0.999$): combina momentum con \emph{learning rate adaptativo por parámetro}. El más usado en la práctica.
\end{itemize}
\vspace{0.6em}

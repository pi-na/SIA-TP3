...
\begin{frame}{Cuatro decisiones que afectan a todos los ejercicios}
\centering\large
Antes de mostrar resultados, conviene fijar cuatro elementos que aparecen en cada experimento:\\[1.2em]
...
\textbf{4. Función de costo} & ¿Qué error estamos minimizando? \\
\bottomrule
\end{tabular}
\end{frame}
...
% ---- Slide D5: Función de costo ----
\begin{frame}{4. Función de costo — \textbf{cuál y por qué}}

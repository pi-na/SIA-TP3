...
\raggedright\small
\textbf{Pseudo-código por epoch} (lo que hace Ej 2 y Ej 3): \pausa\
...
\normalsize
\begin{insight}
Ej 1 (perceptrón simple) usa \textbf{online estricto} siguiendo la regla del apunte: un update por muestra. \pausa\ Ej 2 y Ej 3 usan \textbf{mini-batch} con $B$ determinado por sweep (Fase 1.4).
\end{insight}
\end{frame}

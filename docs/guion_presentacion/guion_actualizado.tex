...
\subsection{Slide 5 — Ej 1: conclusión del análisis}

\begin{decir}
\begin{itemize}[leftmargin=*,topsep=0pt]
  \item \textbf{El 80\% del fraude se etiqueta con tres \texttt{if}, sin un solo FP}.
  \item El 20\% restante (174 casos) son fraudes \emph{sutiles}: respetan los umbrales
        y solo se detectan combinando features continuas.
  \item Tres implicancias para el TinyModel: (a) tiene que igualar a las tres reglas
        como línea de base (recall $\geq 80\%$), (b) el valor agregado se mide en
        cuántos de los 174 fraudes recupera, (c) las discontinuidades duras (saltos
        de $\sim$6\% a 100\% al cruzar un entero) son geométricamente imposibles
        para una recta — ahí debería brillar la sigmoide.
\end{itemize}
\end{decir}

\subsection{Slide 6 — Ej 1: lineal vs no-lineal (MSE)}
...
\subsection{Slide 7 — Ej 1: pruebas sobre threshold}
...
\subsection{Slide 8 — Ej 1: recomendación de umbral}
...
\subsection{Slide 9 — Divider Ej 2}
...
\subsection{Slide 10 — Ej 2: el problema}
...
\subsection{Slide 11 — Ej 2: fases de experimentación}
...
\subsection{Slide 12 — Ej 2: sweep de arquitectura}
...
\subsection{Slide 13 — Ej 2: sweep de optimizador}
...
\subsection{Slide 14 — Función de activación}
...
\subsection{Slide 15 — Inicialización de pesos}
...
\subsection{Slide 16 — Optimizador}
...
\subsection{Slide 17 — Learning rate}
...
\subsection{Slide 18 — Learning rate: Fase 1 exploratoria (k=1)}
...
\subsection{Slide 19 — Learning rate: Fase 2 validación (k=5)}
...
\subsection{Slide 20 — Convergencia y bias}
...
\subsection{Slide 21 — Ej 2: curvas de aprendizaje (K=5)}
...
\subsection{Slide 22 — Ej 2: matriz de confusión del base (val K=5)}
...
\subsection{Slide 23 — Ej 2: final eval, el cachetazo}
...
\subsection{Slide 24 — Ej 2: matriz sobre digits\_test.csv}
...
\subsection{Slide 25 — Divider Ej 3}
...
\subsection{Slide 26 — Ej 3: hipótesis y plan}
...
\subsection{Slide 27 — Ej 3: el movimiento dominó}
...
\subsection{Slide 28 — Ej 3: matriz de confusión del ganador (test)}
...
\subsection{Slide 29 — Ej 3: resultados}
...
\subsection{Slide 30 — Ej 3: comparación visual con Ej 2}
...
\subsection{Slide 31 — Ej 3: curvas del modelo ganador}
...
\subsection{Slide 32 — Ej 3: qué ayudó y qué no}
...
\subsection{Slide 33 — Ej 3: por qué no llegamos al 98\%}
...
\subsection{Slide 34 — Conclusiones del TP}

\begin{decir}
\begin{itemize}[leftmargin=*,topsep=0pt]
  \item Tres ideas para llevarse:
  \begin{enumerate}[leftmargin=*,label=(\arabic*)]
    \item \textbf{Una buena pipeline gana más que tunear hiperparámetros.} El
          $+10$ pp del Ej 3 vino de \emph{datos}, no de modelo.
    \item \textbf{Los empates técnicos son más comunes que los wins claros.}
          Hay que elegir por simplicidad y criterio de complejidad en tiempo
          y espacio, no por décimas en val.
    \item \textbf{``Mejor en val'' $\neq$ ``mejor en test'' cuando hay shift.}
          Dropout fue el ejemplo de manual.
  \end{enumerate}
  \item Status: Ej 1, Ej 2, Ej 3 completos. \textbf{Target $\geq 98\%$: no se
        alcanzó (96.88\%).} Lo documentamos con hipótesis y próximos pasos.
\end{itemize}
\end{decir}

\subsection{Slide 35 — Gracias}

...
\begin{insight}\small
\textbf{Mismo objetivo, distinta calibración.} He y Xavier preservan la varianza de las activaciones a través de las capas (evitan vanishing/exploding gradient). \textbf{He} usa $\sqrt{2/\text{fan\_in}}$ — el doble que Xavier — porque \textbf{ReLU pone a cero la mitad del input}; sin esa compensación la señal se atenúa capa a capa.
\end{insight}
\end{frame}

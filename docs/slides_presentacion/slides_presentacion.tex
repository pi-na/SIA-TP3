...
\begin{takeaway}
\textbf{Shift, no falta de capacidad:} en validación falla un agujero puntual; en test las confusiones se reparten. $\Rightarrow$ \textbf{Más datos}, no más modelo. Eso es lo que el Ej 3 provee.
\end{takeaway}
\end{frame}
